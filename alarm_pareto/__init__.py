...
how much downtime they cause, by three different downtime measures. The results
go into an Excel workbook and a PowerPoint deck.
...
Module order in the pipeline:
    ...
    reporting_range -> work out which blocks of clock time the report covers
